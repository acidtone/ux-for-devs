...
---
## Headings
**Heading**: The headline that acts as a title of a section of text.

**Header**: The banner at the top of a website that usually contains the logo and navigation.

**`head`**: The HTML element that contains the meta data of a web page.
